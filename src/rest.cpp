...
namespace vrv
{
    ...
    RestOffsets g_defaultRests{
        {RL_otherLayer,
         {{RA_none,
           {{RLP_restOnTopLayer,
             {{RNP_noteInSpace,
               {{DUR_1, 3}, {DUR_2, 3}, {DUR_4, 5}, {DUR_8, 5}, {DUR_16, 7}, {DUR_32, 7}, {DUR_64, 9}, {DUR_128, 9}, {DUR_LG, 5}, {DUR_BR, 5}}},
              {RNP_noteOnLine,
               {{DUR_1, 2}, {DUR_2, 4}, {DUR_4, 6}, {DUR_8, 4}, {DUR_16, 6}, {DUR_32, 6}, {DUR_64, 8}, {DUR_128, 8}, {DUR_LG, 6}, {DUR_BR, 4}}}}},
            {RLP_restOnBottomLayer,
             {{RNP_noteInSpace,
               {{DUR_1, -5}, {DUR_2, -5}, {DUR_4, -5}, {DUR_8, -5}, {DUR_16, -5}, {DUR_32, -7}, {DUR_64, -7}, {DUR_128, -9}, {DUR_LG, -5}, {DUR_BR, -5}}},
              {RNP_noteOnLine,
               {{DUR_1, -6}, {DUR_2, -6}, {DUR_4, -6}, {DUR_8, -4}, {DUR_16, -4}, {DUR_32, -6}, {DUR_64, -6}, {DUR_128, -8}, {DUR_LG, -6}, {DUR_BR, -6}}}}}}},
          {RA_s,
           {{RLP_restOnTopLayer,
             {{RNP_noteInSpace,
               {{DUR_1, 3}, {DUR_2, 5}, {DUR_4, 7}, {DUR_8, 5}, {DUR_16, 7}, {DUR_32, 7}, {DUR_64, 9}, {DUR_128, 9}, {DUR_LG, 5}, {DUR_BR, 5}}},
              {RNP_noteOnLine,
               {{DUR_1, 2}, {DUR_2, 4}, {DUR_4, 6}, {DUR_8, 6}, {DUR_16, 8}, {DUR_32, 8}, {DUR_64, 10}, {DUR_128, 10}, {DUR_LG, 6}, {DUR_BR, 4}}}}},
            {RLP_restOnBottomLayer,
             {{RNP_noteInSpace,
               {{DUR_1, -5}, {DUR_2, -5}, {DUR_4, -5}, {DUR_8, -5}, {DUR_16, -5}, {DUR_32, -7}, {DUR_64, -7}, {DUR_128, -9}, {DUR_LG, -5}, {DUR_BR, -5}}},
              {RNP_noteOnLine,
               {{DUR_1, -6}, {DUR_2, -6}, {DUR_4, -6}, {DUR_8, -6}, {DUR_16, -6}, {DUR_32, -6}, {DUR_64, -6}, {DUR_128, -8}, {DUR_LG, -6}, {DUR_BR, -6}}}}}}},
          {RA_f,
           {{RLP_restOnTopLayer,
             {{RNP_noteInSpace,
               {{DUR_1, 3}, {DUR_2, 5}, {DUR_4, 5}, {DUR_8, 5}, {DUR_16, 7}, {DUR_32, 7}, {DUR_64, 9}, {DUR_128, 9}, {DUR_LG, 5}, {DUR_BR, 5}}},
              {RNP_noteOnLine,
               {{DUR_1, 4}, {DUR_2, 4}, {DUR_4, 6}, {DUR_8, 6}, {DUR_16, 8}, {DUR_32, 8}, {DUR_64, 10}, {DUR_128, 10}, {DUR_LG, 6}, {DUR_BR, 4}}}}},
            {RLP_restOnBottomLayer,
             {{RNP_noteInSpace,
               {{DUR_1, -5}, {DUR_2, -5}, {DUR_4, -5}, {DUR_8, -5}, {DUR_16, -5}, {DUR_32, -7}, {DUR_64, -7}, {DUR_128, -9}, {DUR_LG, -5}, {DUR_BR, -5}}},
              {RNP_noteOnLine,
           ...
           {{RLP_restOnTopLayer,
            ...
            {RLP_restOnBottomLayer,
             {{RNP_noteInSpace,
               {{DUR_1, -5}, {DUR_2, -5}, {DUR_4, -5}, {DUR_8, -5}, {DUR_16, -5}, {DUR_32, -7}, {DUR_64, -7}, {DUR_128, -9}, {DUR_LG, -5}, {DUR_BR, -5}}},
              {RNP_noteOnLine,
               {{DUR_1, -6}, {DUR_2, -4}, {DUR_4, -6}, {DUR_8, -4}, {DUR_16, -4}, {DUR_32, -6}, {DUR_64, -6}, {DUR_128, -8}, {DUR_LG, -6}, {DUR_BR, -6}}}}}}},
          {RA_x,
           {{RLP_restOnTopLayer,
             {{RNP_noteInSpace,
               {{DUR_1, 3}, {DUR_2, 3}, {DUR_4, 5}, {DUR_8, 5}, {DUR_16, 7}, {DUR_32, 7}, {DUR_64, 9}, {DUR_128, 9}, {DUR_LG, 5}, {DUR_BR, 5}}},
              {RNP_noteOnLine,
               {{DUR_1, 2}, {DUR_2, 6}, {DUR_4, 6}, {DUR_8, 6}, {DUR_16, 8}, {DUR_32, 8}, {DUR_64, 10}, {DUR_128, 10}, {DUR_LG, 6}, {DUR_BR, 4}}}}},
            {RLP_restOnBottomLayer,
             {{RNP_noteInSpace,
               {{DUR_1, -7}, {DUR_2, -5}, {DUR_4, -7}, {DUR_8, -5}, {DUR_16, -5}, {DUR_32, -7}, {DUR_64, -7}, {DUR_128, -9}, {DUR_LG, -5}, {DUR_BR, -5}}},
              {RNP_noteOnLine,
               {{DUR_1, -6}, {DUR_2, -6}, {DUR_4, -6}, {DUR_8, -6}, {DUR_16, -6}, {DUR_32, -6}, {DUR_64, -6}, {DUR_128, -8}, {DUR_LG, -6}, {DUR_BR, -6}}}}}}}}},
        {RL_sameLayer,
         {{RA_none,
           {{RLP_restOnTopLayer,
             {{RNP_noteInSpace,
               {{DUR_1, -1}, {DUR_2, 1}, {DUR_4, 1}, {DUR_8, 1}, {DUR_16, 3}, {DUR_32, 3}, {DUR_64, 5}, {DUR_128, 5}, {DUR_LG, 3}, {DUR_BR, 1}}},
              {RNP_noteOnLine,
               {{DUR_1, 0}, {DUR_2, 0}, {DUR_4, 2}, {DUR_8, 2}, {DUR_16, 2}, {DUR_32, 2}, {DUR_64, 4}, {DUR_128, 4}, {DUR_LG, 2}, {DUR_BR, 2}}}}},
            {RLP_restOnBottomLayer,
             {{RNP_noteInSpace,
               {{DUR_1, -3}, {DUR_2, -1}, {DUR_4, -1}, {DUR_8, -1}, {DUR_16, -1}, {DUR_32, -3}, {DUR_64, -3}, {DUR_128, -5}, {DUR_LG, -3}, {DUR_BR, -3}}},
              {RNP_noteOnLine,
               {{DUR_1, -2}, {DUR_2, -2}, {DUR_4, -2}, {DUR_8, -2}, {DUR_16, -2}, {DUR_32, -4}, {DUR_64, -4}, {DUR_128, -6}, {DUR_LG, -2}, {DUR_BR, -2}}}}}}}}}};
    ...
    RestAccidental MeiAccidentalToRestAccidental(data_ACCIDENTAL_WRITTEN accidental)
    {
        switch (accidental)
        {
        case ACCIDENTAL_WRITTEN_s:
            return RA_s;
        case ACCIDENTAL_WRITTEN_f:
            return RA_f;
        case ACCIDENTAL_WRITTEN_x:
            return RA_x;
    ...
    Rest::Rest()
        : LayerElement(REST, "rest-"), DurationInterface(), PositionInterface(), AttColor(), AttCue(), AttExtSym(), AttRestVisMensural()
    {
    ...
    wchar_t Rest::GetRestGlyph(const int duration) const
    {
        ...
        if (this->HasGlyphNum())
        {
            ...
            if (NULL != resources->GetGlyph(code))
                return code;
        }
        ...
        {
        case DUR_LG:
            return SMUFL_E4E1_restLonga;
            break;
        case DUR_BR:
            return SMUFL_E4E2_restDoubleWhole;
            break;
        case DUR_1:
            return SMUFL_E4E3_restWhole;
            break;
        case DUR_2:
            return SMUFL_E4E4_restHalf;
            break;
        case DUR_4:
            return SMUFL_E4E5_restQuarter;
            break;
        case DUR_8:
            return SMUFL_E4E6_rest8th;
            break;
        case DUR_16:
            return SMUFL_E4E7_rest16th;
            break;
        case DUR_32:
            return SMUFL_E4E8_rest32nd;
            break;
        case DUR_64:
            return SMUFL_E4E9_rest64th;
            break;
        case DUR_128:
            return SMUFL_E4EA_rest128th;
            break;
        case DUR_256:
            return SMUFL_E4EB_rest256th;
            break;
        case DUR_512:
            return SMUFL_E4EC_rest512th;
            break;
        case DUR_1024:
            return SMUFL_E4ED_rest1024th;
            break;
        }
        return 0;
    }
    ...
    int Rest::GetOptimalLayerLocation(const Staff *staff, const Layer *layer, int defaultLocation) const
    {
        ...
        const bool isTopLayer = m_crossStaff ? (staff->GetN() < m_crossStaff->GetN()) : (layer->GetN() == *layersN.cbegin());
        ...
        const auto otherLayerRelativeLocationInfo = this->GetLocationRelativeToOtherLayers(layers, layer, isTopLayer, restOverlap);
        int currentLayerRelativeLocation = this->GetLocationRelativeToCurrentLayer(staff, layer, isTopLayer);
        int otherLayerRelativeLocation = otherLayerRelativeLocationInfo.first + this->GetRestOffsetFromOptions(RL_otherLayer, otherLayerRelativeLocationInfo, isTopLayer);
        ...
        else
        {
            ...
            currentLayerRelativeLocation += this->GetRestOffsetFromOptions(RL_sameLayer, currentLayerRelativeLocationInfo, isTopLayer);
        }
        if (m_crossStaff)
        {
            if (isTopLayer)
        ...
        const ListOfConstObjects &layersList, const Layer *currentLayer, bool isTopLayer, bool &restOverlap) const
    {
        ...
        auto layerIter = std::find_if(layersList.begin(), layersList.end(),
                                      [&](const Object *foundLayer)
                                      { return vrv_cast<const Layer *>(foundLayer)->GetN() != currentLayer->GetN(); });
        ...
        for (const Object *object : collidingElementsList)
        {
            ...
            if (currentElementInfo.first == VRV_UNSET)
                continue;
            ...
            if (this->GetAlignment()->GetTime() != vrv_cast<const LayerElement *>(object)->GetAlignment()->GetTime())
            {
                ...
                {
                    if (finalElementInfo.first != VRV_UNSET)
                        continue;
                    currentElementInfo.first = isTopLayer ? 12 : -4;
                }
            }
            if ((VRV_UNSET == finalElementInfo.first) || (isTopLayer && (finalElementInfo.first < currentElementInfo.first)) || (!isTopLayer && (finalElementInfo.first > currentElementInfo.first)))
            {
        ...
        const Staff *currentStaff, const Layer *currentLayer, bool isPrevious, bool isTopLayer) const
    {
        ...
        if (!relativeMeasure || !relativeMeasure->Is(MEASURE))
            return VRV_UNSET;
        ...
        auto layerIter = std::find_if(layers.begin(), layers.end(),
                                      [&](const Object *foundLayer)
                                      { return vrv_cast<const Layer *>(foundLayer)->GetN() == currentLayer->GetN(); });
        if (((int)layers.size() != currentStaff->GetChildCount(LAYER)) || (layerIter == layers.end()))
            return VRV_UNSET;
    ...
    int Rest::GetMarginLayerLocation(bool isTopLayer, bool restOverlap) const
    {
        ...
        {
            marginLocation = isTopLayer ? (6 + (this->GetDur() - DURATION_4) / 2 * 2) : (2 - (this->GetDur() - DURATION_8) / 2 * 2);
        }
        ...
        RestLayer layer, const std::pair<int, RestAccidental> &location, bool isTopLayer) const
    {
        ...
        if (duration > DURATION_128)
            duration = DURATION_128;
    ...
    int Rest::AdjustBeams(FunctorParams *functorParams)
    {
        ...
        if (unitChangeNumber > 0)
            params->m_overlapMargin = unitChangeNumber * staffOffset * params->m_directionBias;
    ...
    int Rest::CalcDots(FunctorParams *functorParams)
    {
        ...
        if (drawingCueSize)
            xRel = params->m_doc->GetCueSize(xRel);
